              ...
              <div className={styles.locationBlockHeader}>
                <div className={styles.wrapper}>
                  <div className={styles.locationBlock}>
                    <Image src="/icon/header-location-icon.svg"
                      height={20}
                      width={20}
                      alt="location icon" />
                  ...
                  <div className={styles.emailBlock}>
                    <Image src="/icon/header-email-icon.svg"
                      height={20}
                      width={20}
                      alt="email icon" />
        ...
        {isMobile && (
          <>
            <div className={styles.mobileMenuButton}>
              <MobileButton icon={<Image src="/icon/header-mobile-menu-icon1.svg"
                height={12}
                width={12}
                alt="mobile menu icon" />}
                iconClick={<Image src="/icon/header-mobile-menu-icon2.svg"
                  height={12}
                  width={12}
                  alt="mobile menu icon" />}
            ...
            <div className={styles.block2}>
              <div className={styles.block3}>
                ...
                <div className={styles.tabletButton2}>
                  <Link href="">
                    <MobileButton
                      icon={<Image src="/icon/header-search-icon.svg"
                        height={16}
                        width={16}
                        alt="catalog icon" />}
                      customStyle={{ width: '39px', height: '39px' }} />
                ...
                <div className={styles.contactCard}>
                  <div className={styles['contact-wrapper']}>
                    ...
                    <div className={styles.image}>
                      <Image src="/image/header-image.png"
                        width={472}
                        height={719}
                        alt="contacts image" />
                    </div>
        ...
        {isMobile && (
          <>
            <Link href="/catalog" className={styles.mobileCatalog}>
              <Image src="/icon/header-mobile-catalog-icon.svg"
                height={15}
                width={15}
            ...
            <Link href="/" className={styles.mobileSearch}>
              <Image src="/icon/header-mobile-search-icon.svg"
                height={15}
                width={15}
